...
public class PatientForgotPassword implements Initializable {
    @FXML
    ...
    private boolean checkUsername(){
        try {
            ...
            String url = "SELECT * FROM patients WHERE username = ?";
    ...
    private boolean updatePassword(){
        try {
            ...
            url = "UPDATE patients set password=? WHERE username = ?";
            preparedStatement = connection.prepareStatement(url);
